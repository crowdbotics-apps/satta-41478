"""
Django settings for satta_41478 project.
...
WSGI_APPLICATION = 'satta_41478.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "satta_41478 API",
    "DESCRIPTION": "API documentation for satta_41478 App",
    "VERSION": "v1",
}
